...
function validate()
{
  ...
  /* Utilisation "ou copie" du modèle (entité ou classe) sur lequel on va se baser pour créer un nouvel objet */
  include __DIR__ . '/../Entity/Information.php';

  /* Création d'un nouvel objet par rapport au modèle ci-dessus */
  $info = new Information();

  /* Dans chaque champ défini auparavant dans l'entité "Information", on va attribuer une valeur. Autrement dit qu'on "hydrate"/associe 
  ...
  /* Enregistrement de la variable $info nouvellement "hydratée" de tous les paramètres */
  $info->save();

  /* Envoi d'un message pour informer l'utilisateur */
