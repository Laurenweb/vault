...
/* Permet d'inclure l'ORM. On utilisera "include_once" pour inclure l'ORM une seule fois lorsqu'il y a plusieurs entités dans un même fichier */
include __DIR__ . '/../../vendor/SimpleOrm.class.php';

/* Création de la structure mémoire d'un utilisateur. La classe hérite de l'ORM ( ici SimpleOrm) */
