...
/* Création d'une variable qui va permettre de donner les informations utiles à SimpleOrm pour se connecter à la base de données */
$conn = new mysqli('127.0.0.1', 'root', '', 'vault', '3306');

/* On donne l'instruction pour la connexion */
SimpleOrm::useConnection($conn, 'vault');

/* Définit le jeu de caractères à utiliser lors de l'envoi de données depuis et vers le serveur de base de données
Syntaxe : mysqli_set_charset(connection, charset) */
